(() => {
  ...
  var require_app = __commonJS({
    "app.js"() {
      ...
      var startX = 0;
      var startY = 0;
      var statusDot = document.getElementById("codex-status-dot");
      var statusText = document.getElementById("codex-status-text");
      ...
      var btnStartCodex = document.getElementById("btn-start-codex");
      var btnRestartCodex = document.getElementById("btn-restart-codex");
      ...
      async function refreshStatus() {
        try {
          ...
          autoLaunchToggle.checked = appConfig.autoLaunchCodex;
      ...
      async function startCodex(forceClean = false) {
        notify("\u6B63\u5728\u542F\u52A8 Codex App...", "info");
        try {
          await invoke("restart_codex");
          notify("Codex \u5DF2\u542F\u52A8\uFF01", "info");
      ...
      async function restartCodex() {
        notify("\u6B63\u5728\u91CD\u542F Codex App...", "info");
        try {
          await invoke("restart_codex");
          notify("Codex \u5DF2\u6210\u529F\u91CD\u542F\uFF01", "info");
          setTimeout(refreshStatus, 3e3);
        } catch (err) {
      ...
      autoLaunchToggle.addEventListener("change", (e) => {
        updateConfig({ autoLaunchCodex: e.target.checked });
      });
      ...
      btnStartCodex.addEventListener("click", () => startCodex(false));
      btnRestartCodex.addEventListener("click", () => restartCodex());
